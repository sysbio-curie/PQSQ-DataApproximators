...
\subsection{Principal Graphs and Manifolds in PQSQ metrics}
...
for arbitrary non-Euclidean metrics with subquadratic growth by using a piecewise-quadratic energy functional (PQSQ potential). These approximators can be computed
